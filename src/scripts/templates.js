  ...
  return `
    <div class="report-detail__header">
      ...
      <div class="report-detail__more-info">
        ...
        <div id="author" class="report-detail__author" data-value="${name}">Status dibuat oleh:</div>
      </div>
    ...
    <div class="container">
      <div class="report-detail__body">
        <div class="report-detail__body__description__container">
          <h2 class="report-detail__description__title">Deskripsi Status</h2>
          <div id="description" class="report-detail__description__body">
            ${description}
          </div>
        </div>
        <div class="report-detail__body__map__container">
          <h2 class="report-detail__map__title">Peta Lokasi Status</h2>
